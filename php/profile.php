...
<div id="profileForm" class=" container-fluid " style="margin-top: 80px; display: flex; align-items: center; flex-direction: column;">
    <div class="row">
	    <div class="col-sm-12">
		     <div class="card">
			      <div class="card-body">
					  ...
					  <div class="row m-1">
					      <label class="col-4">Full names</label>
						   <input id="name" class="col-8" type="input"/>
					  </div>
					  <div class="row m-1">
					      <label class="col-4">Email</label>
						   <input  id="email" class="col-8" type="input"/>
					  </div>
					  <div class="row m-1">
					      <label class="col-4">Tel</label>
						   <input  id="tel"  class="col-8" type="input"/>
					  </div>
					  <div class="text-center m-1">
						   <input id="saveChanges" class="btn btn-sm btn-purple" type="button" value="save changes"/>
					  </div>
				  </div>
			    </div>
			 <div class="card mt-2">
			     <div class="card-body">
				    <h5 class="card-title text-center"> Security setings</h5>
					<div class="row m-1">
					  <label  class="col-5">Old password</label>
					  <input id="oldpass" class="col-7" type="password"/>
					</div>
					<div class="row m-1">
					  <label  class="col-5"> New password</label>
					  <input id="newPass" class="col-7" type="password"/>
					</div>
					<div class="row m-1">
					   <label class="col-5">Retype password</label>
					   <input id="retypespass" class="col-7" type="password"/>
					</div>
					<div class="text-center m-1">
					 <input id="savePasword" type="button" class="btn btn-sm btn-purple" value="save changes"/>
					</div>
				 </div>
			 </div>
			 <div class="card mt-2">
			    <div class="card-body">
				   ...
				   <div class="row m-1">
					   ...
					   <input class="col-8" type="email"/>
				   </div>
				   <div class="row m-1">
				       <label class="col-3 ">Tel</label>
					   <input class="col-8" type="tel"/>
				   </div>
				   <div class="text-center m-1">
					 <input id="fabtn" type="button" class="btn btn-sm btn-purple" value="add"/>
				   </div>
				   <div>
				</div>
			 </div>
		...
		<div class="card mt-2">
		   <div class="card-body">
			   ...
			   <a  href="orderHistory.php">Click here</a>
			   </div>
		   </div>
		</div>
	</div>
...
<div class="container-fluid footer-class bottom" >
	<div class="row" >
